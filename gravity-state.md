...
- Objetivo Activo: Solución y guía de Ajustes Restringidos (Android 13+) en el interruptor de Notificaciones.
- Última Acción: Añadida orientación dinámica en UI y Toasts para desbloquear 'Ajustes Restringidos' en Android 13+ cuando el permiso de notificaciones aparece gris. Recompilado y desplegado APK v1.1.3 a `main` (commit `9716165`).
...
- Siguiente Paso: Prueba por parte del tester siguiendo la guía de Ajustes Restringidos.
...
- Último commit revisado: 9716165
